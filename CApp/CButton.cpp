...
void CButton::Activate()
{
    ...
    switch(eButtonType)
	{
		...
		case BUTTON_CREATECHAR_STR_PLUS:
		case BUTTON_CREATECHAR_STR_MINUS:
		case BUTTON_CREATECHAR_CON_PLUS:
		case BUTTON_CREATECHAR_CON_MINUS:
		case BUTTON_CREATECHAR_DEX_PLUS:
		case BUTTON_CREATECHAR_DEX_MINUS:
		case BUTTON_CREATECHAR_INT_PLUS:
		case BUTTON_CREATECHAR_INT_MINUS:
		case BUTTON_CREATECHAR_WIS_PLUS:
		case BUTTON_CREATECHAR_WIS_MINUS:
		case BUTTON_CREATECHAR_CHA_PLUS:
		case BUTTON_CREATECHAR_CHA_MINUS:
        {
