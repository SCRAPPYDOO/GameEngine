...
//------------------------------------------------------------------------------
void CEvent::OnMinimize() { /* Pure virtual, do nothing */ }

void CEvent::OnRestore() { /* Pure virtual, do nothing */ }

void CEvent::OnResize(int w,int h) { /* Pure virtual, do nothing */ }

void CEvent::OnExpose() {}

void CEvent::OnExit() {}

void CEvent::OnUser(Uint8 type, int code, void* data1, void* data2) { /* Pure virtual, do nothing */ }
