...
void CObjectUnit::OnRender(SDL_Surface* Surf_Display) 
{
...
void CObjectUnit::OnAnimate() 
{
    Anim_Control.OnAnimate();
}

void CObjectUnit::OnMoveToPoint(int nGoPosX, int nGoPosY)
{
...
double CObjectUnit::GetDistance(float x1, float y1, float x2, float y2 )
{ 
    return sqrt(pow( x2 - x1, 2) + pow( y2 - y1, 2));
}

bool CObjectUnit::IsInRange(CUnit* pUnit)
{
...
bool CObjectUnit::IsOnPoint(int goX, int goY)
{
...
void CObjectUnit::StopMove() 
{
    //eMovementFlag = MOVEMENT_FLAG_NOTMOVE;
}

int CObjectUnit::GetAnimPosX()
{
